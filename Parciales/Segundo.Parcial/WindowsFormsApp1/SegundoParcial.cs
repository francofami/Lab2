...
namespace SP
{
    ...
    public partial class SegundoParcial: Form
    {
        ...
        private static string ObtenerListadoFrutas()
        {
            ...
            List<Fruta> nuevaLista = new List<Fruta>();
            int indice = 1;
            ...
            comandoSql.CommandText = string.Format("SELECT * FROM dbo.frutas WHERE 1=1");
            ...
            while (lector.Read())
            {
                retorno.Append("ID: " + (int)lector[0]);
                retorno.Append(" Nombre: " + (string)lector[1]);
                retorno.Append(" Peso: " + (double)lector[2]);
                retorno.Append(" Precio: " + (double)lector[3] + "\n");
                indice++;
            }
